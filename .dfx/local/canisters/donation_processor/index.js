...
import { idlFactory } from './donation_processor.did.js';
export { idlFactory } from './donation_processor.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DONATION_PROCESSOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./donation_processor.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the donation_processor canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./donation_processor.did.js")._SERVICE>}
 */
export const donation_processor = createActor(canisterId);
