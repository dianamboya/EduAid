...
import { idlFactory } from './rwa_registry.did.js';
export { idlFactory } from './rwa_registry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RWA_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rwa_registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rwa_registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rwa_registry.did.js")._SERVICE>}
 */
export const rwa_registry = createActor(canisterId);
