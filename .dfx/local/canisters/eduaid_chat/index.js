...
import { idlFactory } from './eduaid_chat.did.js';
export { idlFactory } from './eduaid_chat.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EDUAID_CHAT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./eduaid_chat.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the eduaid_chat canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./eduaid_chat.did.js")._SERVICE>}
 */
export const eduaid_chat = createActor(canisterId);
