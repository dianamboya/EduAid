...
import { idlFactory } from './user_profiles.did.js';
export { idlFactory } from './user_profiles.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USER_PROFILES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./user_profiles.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the user_profiles canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./user_profiles.did.js")._SERVICE>}
 */
export const user_profiles = createActor(canisterId);
