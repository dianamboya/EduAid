...
import { idlFactory } from './student_backend.did.js';
export { idlFactory } from './student_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STUDENT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./student_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the student_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./student_backend.did.js")._SERVICE>}
 */
export const student_backend = createActor(canisterId);
